<?php include_once "header.php"; ?>
    ...
    <!-- view products -->
    <div class=" float-start p-3 position-sticky shadow-sm  border-end  rounded" style="top: 0%; width: 20%;">
    ...
    <div class="">
        <div class="  float-end p-3  rounded" style="width: 80%;">
            ...
            <ul class="classfied-wrap list-unstyled d-none s-sm-none d-lg-block">
                <?php
                include "config.php";
                $micro_id = $_GET['micro_id'];
